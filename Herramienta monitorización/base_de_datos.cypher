...
MATCH (a:Alumno {mac:'24:A1:60:75:E4:68'}), (b:Alumno {mac:'24:A1:60:75:E4:54'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:68'}), (b:Alumno {mac:'24:A1:60:75:E4:D7'}) CREATE (a)-[r:CERCA_DE {rssi:'Cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:B0'}), (b:Alumno {mac:'24:A1:60:75:E4:79'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:B0'}), (b:Alumno {mac:'24:A1:60:75:E4:54'}) CREATE (a)-[r:CERCA_DE {rssi:'Cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:B0'}), (b:Alumno {mac:'24:A1:60:75:E4:D7'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:54'}), (b:Alumno {mac:'24:A1:60:75:E4:D7'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:D7'}), (b:Alumno {mac:'24:A1:60:75:E4:87'}) CREATE (a)-[r:CERCA_DE {rssi:'Cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:D7'}), (b:Alumno {mac:'24:A1:60:75:E4:79'}) CREATE (a)-[r:CERCA_DE {rssi:'Cercanía moderada', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:79'}), (b:Profesor {mac:'24:A1:60:75:E4:12'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:79'}), (b:Alumno {mac:'24:A1:60:75:E4:C3'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:79'}), (b:Alumno {mac:'24:A1:60:75:E4:87'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:87'}), (b:Alumno {mac:'24:A1:60:75:E4:C3'}) CREATE (a)-[r:CERCA_DE {rssi:'Cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:C3'}), (b:Profesor {mac:'24:A1:60:75:E4:12'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:C3'}), (b:Alumno {mac:'24:A1:60:75:E4:92'}) CREATE (a)-[r:CERCA_DE {rssi:'Cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:C3'}), (b:Alumno {mac:'24:A1:60:75:E4:06'}) CREATE (a)-[r:CERCA_DE {rssi:'Cercanía moderada', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:06'}), (b:Alumno {mac:'24:A1:60:75:E4:92'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:06'}), (b:Alumno {mac:'24:A1:60:75:E4:A1'}) CREATE (a)-[r:CERCA_DE {rssi:'Cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:92'}), (b:Alumno {mac:'24:A1:60:75:E4:A1'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'9'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:87'}), (b:Alumno {mac:'24:A1:60:75:E4:B0'}) CREATE (a)-[r:CERCA_DE {rssi:'Cercanía moderada', hora:'9'}]->(b)

MATCH (a:Alumno {mac:'24:A1:60:75:E4:68'}), (b:Alumno {mac:'24:A1:60:75:E4:B0'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:68'}), (b:Alumno {mac:'24:A1:60:75:E4:87'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:68'}), (b:Alumno {mac:'24:A1:60:75:E4:54'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:68'}), (b:Alumno {mac:'24:A1:60:75:E4:D7'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:B0'}), (b:Alumno {mac:'24:A1:60:75:E4:54'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:B0'}), (b:Alumno {mac:'24:A1:60:75:E4:D7'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:B0'}), (b:Alumno {mac:'24:A1:60:75:E4:87'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:54'}), (b:Alumno {mac:'24:A1:60:75:E4:D7'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:54'}), (b:Alumno {mac:'24:A1:60:75:E4:87'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:D7'}), (b:Alumno {mac:'24:A1:60:75:E4:87'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:79'}), (b:Profesor {mac:'24:A1:60:75:E4:12'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:79'}), (b:Alumno {mac:'24:A1:60:75:E4:C3'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:79'}), (b:Alumno {mac:'24:A1:60:75:E4:92'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:92'}), (b:Profesor {mac:'24:A1:60:75:E4:12'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:92'}), (b:Alumno {mac:'24:A1:60:75:E4:C3'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:C3'}), (b:Profesor {mac:'24:A1:60:75:E4:12'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
MATCH (a:Alumno {mac:'24:A1:60:75:E4:A1'}), (b:Alumno {mac:'24:A1:60:75:E4:06'}) CREATE (a)-[r:CERCA_DE {rssi:'Muy cerca', hora:'11'}]->(b)
