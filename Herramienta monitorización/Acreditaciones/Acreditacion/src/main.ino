...
const char* topicEnvio = "TFG/Acreditacion/Datos";
const char* topicRecibir = "TFG/Acreditacion/Monitorizacion";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(mqtt_server)) {
      ...
      //Se subscribe al topic predefinido para el recibo de mensajes
